...
//
//        }
        Employee newEmployee = employeeService.addEmployee((com.courseproj.employeemanager.appEmployee.model.Employee) employee);
    ...
    public ResponseEntity<Employee> updateEmployee(@RequestBody @Valid Employee employee, boolean exception)
        ...
        Employee updateEmployee = employeeService.updateEmployee((com.courseproj.employeemanager.appEmployee.model.Employee) employee);
